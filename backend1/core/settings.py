...
# Ensure that you have ASGI application configured, e.g., using Daphne or Uvicorn.
...
DEFAULT_FROM_EMAIL = "helpdesk@aptaracorp.com"
DOMAIN = env("DOMAIN")
...
DJOSER = {
    ...
    "EMAIL":{
        'activation': 'alt_text_generator.email.ActivationEmail'
    },
    "PERMISSIONS":
    {
